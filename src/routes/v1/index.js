...
// import { YandexWebSearch } from '../../controllers/webSearchController';
...
const { YandexWebSearch,GoogleSearch, DuckDuckGoSearch} = require('../../controllers/webSearchController');
const { GoogleImagesSearch,GoogleReverseImageSearch,YandexImageSearch} = require('../../controllers/ImageSearchControllers');
